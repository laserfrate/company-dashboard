                        ...
                        <div className="section">
                            ...
                            {isEmptyData(result.googlePlacesData) ? (
                                ...
                                <div className="formatted-data">
                                    ...
                                    {result.googlePlacesData.opening_hours && (
                                        <div>
                                            <h4>Opening Hours:</h4>
                                    ...
                                    {result.googlePlacesData.photos && result.googlePlacesData.photos.length > 0 && (
                                        <div>
                                            ...
                                            {result.googlePlacesData.photos.map((photo, idx) => (
                                                <img key={idx} src={`https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${photo.photo_reference}&key=${process.env.GOOGLE_PLACES_API_KEY}`} alt="Place" />
                                            ))}
                                        </div>
                                    )}
